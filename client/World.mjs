...
export default class World {
    ...
    tick = () => {
      ...
      if(this.rootBody) {
        ...
        this.session.moveBody(this.rootBody.id, this.rootBody.position, this.rootBody.velocity)
        this.session.rotateBody(this.rootBody.id, this.rootBody.quaternion, this.rootBody.angularVelocity)
      }
    }
