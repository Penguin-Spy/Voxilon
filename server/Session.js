...
define(['ws', 'common/World', 'common/PacketDecoder', 'common/PacketEncoder', 'server/Player', 'common/CelestialBody'],
       function(ws, World, PacketDecoder, PacketEncoder, Player, CelestialBody) {
